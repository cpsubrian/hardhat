...
module.exports = function(dirIn, dirOut, options, callback) {
  ...
  var pathMatch = function pathMatch (path) {
    var type = {}.toString.call(options.match);
    if (type === '[object RegExp]') {
      return options.match.test(path);
    }
    else if (type === '[object String]') {
      return ~path.indexOf(options.match);
    }
    else if (type === '[object Function]') {
      return options.match(path);
    }
    return true;
  };
